...
<body>
	...
	<c:url var="updateLink"
		value="${pageContext.request.contextPath}/user/posts/update">
	...
	<c:url var="deleteLink"
		value="${pageContext.request.contextPath}/user/posts/delete">
		<c:param name="postId" value="${post.id}" />
	</c:url>
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="float-left">
							<a href="#" class="btn btn-outline-danger btn-sm">Like</a> 
							<a href="#" class="btn btn-outline-success btn-sm">Comment</a>
						</div>
